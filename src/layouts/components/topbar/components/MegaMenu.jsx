...
import { TbChartLine, TbBulb, TbCurrencyDollar, TbUsers, TbActivity, TbGauge, TbZoomCheck, TbLayoutKanban, TbCalendarStats, TbListCheck, TbUsersGroup, TbClipboardList, TbChartPie, TbFileInvoice, TbUserCircle, TbLock, TbShieldLock, TbNotes, TbSettings, TbKey, TbChevronDown } from 'react-icons/tb';
const megaMenuItems = [{
