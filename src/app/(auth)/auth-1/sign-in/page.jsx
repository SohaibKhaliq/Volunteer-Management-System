...
const Page = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // redirect to home (or admin area based on role)
      router.push('/');
    } catch (err) {
          ...
          <Card className="p-4">
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="mb-3 form-group">
                ...
                <FormControl value={password} onChange={(e) => setPassword(e.target.value)} type="password" placeholder="••••••••" required />
              </div>

              <div className="d-flex justify-content-between align-items-center mb-3">
                <div className="form-check">
                  <input className="form-check-input form-check-input-light fs-14" checked={remember} onChange={(e) => setRemember(e.target.checked)} type="checkbox" id="rememberMe" />
