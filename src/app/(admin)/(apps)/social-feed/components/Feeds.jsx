...
const Post1 = () => {
  return <CommonPostCard avatar={user10} name={'Jeremy Tomlinson'} time={'about 2 minutes ago'} description="Story based around the idea of time lapse, animation to post soon!">
      <Row className="g-1">
        <Col md={6}>
          <Image src={gallery1} className="img-fluid w-100 h-100 rounded" style={{
          aspectRatio: '3/4',
          objectFit: 'cover'
        }} alt="Tall Image" />
        </Col>
        ...
        <Col md={6} className="d-flex flex-column gap-1">
          <Image src={gallery2} className="img-fluid w-100 rounded" style={{
          aspectRatio: '4/3',
          objectFit: 'cover'
        }} alt="Top Right" />
          <Image src={gallery3} className="img-fluid w-100 rounded" style={{
          aspectRatio: '4/3',
          objectFit: 'cover'
        }} alt="Bottom Right" />
        </Col>
