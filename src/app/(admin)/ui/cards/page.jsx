...
const CardWithActionToolsBgColor = () => {
  return <ComponentCard title='Card with Action Tools & Background Colors' isCloseable isCollapsible isRefreshable className="text-bg-dark border-0" headerClassName='card-header border-light border-opacity-25'>
        <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
        <Link href="" className="btn btn-sm btn-light">
          Go somewhere
        </Link>
